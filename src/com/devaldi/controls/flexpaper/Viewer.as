...
package com.devaldi.controls.flexpaper
{
	...
	public class Viewer extends Canvas
	{
		...
		private var _printEnabled:Boolean = false;
		private var _printVisible:Boolean = false;
		...
		//打印按钮是否可用
		public function get PrintEnabled():Boolean {
			return _printEnabled;
		}
		
		public function set PrintEnabled(b:Boolean):void {
			_printEnabled = b;
		}
		
		public function get PrintVisible():Boolean {
			return _printVisible;
		}
		
		public function set PrintVisible(b:Boolean):void {
			_printVisible = b;
		}
		...
		private var bookmark:Bookmark =  new Bookmark();
		public function bookMarks():void{
			if(!bookmark.isPopUp){
				
				bookmark.x = 5;
				bookmark.y = 26;
				bookmark.viewer = this;
	//			gotoPage(5);
				PopUpManager.addPopUp(bookmark, this, false);
				
			}
		
//			contentViewer = new PrintRangeDialog(); 
...
//			trace(m);
		...
		public function get tocpath():String {
			return _tocpath;
		}	
		
		public function set tocpath(tocpath:String):void{
			_tocpath = tocpath;
		}
